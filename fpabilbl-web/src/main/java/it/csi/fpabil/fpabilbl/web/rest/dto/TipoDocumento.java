...
@ApiModel(description="L'oggetto rappresentante il tipo documento")
...
public class TipoDocumento  implements Serializable {
  ...
  /**
   * la descrizione del tipo documento
   **/
  
  @ApiModelProperty(value = "la descrizione del tipo documento")
